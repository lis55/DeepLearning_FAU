...
class Conv:
    ...
    def initialize(self, weight_initializer, bias_initializer):
        ...
        self.weights = weight_initializer.initialize(self.weights,fan_in,fan_out)
